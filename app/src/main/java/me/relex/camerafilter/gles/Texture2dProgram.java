...
public class Texture2dProgram {
    ...
    public enum ProgramType {
        /*TEXTURE_2D,*/  //不适用于相机 GL_TEXTURE_EXTERNAL_OES 模式
        ...
        TEXTURE_EXT_DENT, TEXTURE_EXT_FISH_EYE, TEXTURE_EXT_STRETCH, TEXTURE_EXT_MIRROR,
        TEXTURE_EXT_FILT
    }
        ...
        switch (programType) {
           /* case TEXTURE_2D:
            ...
            case TEXTURE_EXT_CHROMA_KEY:
                mTextureTarget = GLES11Ext.GL_TEXTURE_EXTERNAL_OES;
                mProgramHandle =
                        GlUtil.createProgram(VERTEX_SHADER, FRAGMENT_SHADER_EXT_CHROMA_KEY);
                break;
